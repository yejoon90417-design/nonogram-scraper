...
const BOT_SOLVE_TIME_RANGE_SEC = {
  "5x5": { easy: [120, 180], normal: [50, 120], hard: [15, 30] },
  "10x10": { easy: [300, 360], normal: [120, 240], hard: [60, 90] },
  "15x15": { easy: [960, 1500], normal: [600, 900], hard: [300, 420] },
  "20x20": { easy: [1500, 1800], normal: [900, 1200], hard: [420, 600] },
  "25x25": { easy: [2700, 3000], normal: [1260, 2100], hard: [900, 1200] },
};
